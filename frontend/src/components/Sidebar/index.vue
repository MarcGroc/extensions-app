  ...
  <div :class="themeSettingsStore.semidark ? 'dark' : ''">
    <div
      :class="`sidebar-wrapper bg-white dark:bg-slate-800    ${
        ...
        themeSettingsStore.sidebarCollasp ? this.closeClass : this.openClass
      }
    ...
    >
      ...
      >
        <router-link
          :to="{ name: 'home' }"
          v-if="
            !themeSettingsStore.sidebarCollasp ||
            themeSettingsStore.isMouseHovered
          "
        >
          <img
            src="@/assets/images/logo/djavue_logo.jpg"
            alt=""
