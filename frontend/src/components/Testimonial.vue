                    ...
                    <div class="testimonial-slider__wrapper">
                        ...
                        >
                            <swiper-slide class="testimonial-slider__single wow move-up">
                                ...
                                <div class="testimonial-slider__text">{{text.review1Text}}</div>
                            ...
                            <swiper-slide class="testimonial-slider__single wow move-up">
                                ...
                                <div class="testimonial-slider__text">{{text.review2Text}} </div>
                                <div class="testimonial-slider__author">
                            ...
                            <swiper-slide class="testimonial-slider__single wow move-up">
                                ...
                                <div class="testimonial-slider__text">{{text.review3Text}}</div>
                                <div class="testimonial-slider__author">
