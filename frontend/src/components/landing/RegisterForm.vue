    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          <span class="section-text_left wow move-up"
            ><router-link
              class="nav-link hover-style-link hover-style-link--green"
              to="/"
      ...
      <div class="row">
        <div class="col-lg-7 order-2 order-lg-1">
              ...
              <ul class="list ht-social-networks flat-round">
                ...
                <li class="item">
                  <a
                    ...
                    class="social-link"
                  >
                    <i class="fab fa-google social-link-icon"></i>
                  </a>
                </li>
                <!--                                <li class="item">-->
          ...
          <div>
            <span class="section-text_left wow move-up register_or">{{
              text.register_or
            }}</span>
          </div>
            ...
            >
              <div class="contact-page-form">
                ...
                <div class="checkbox">
                  ...
                  <label for="terms">
                    Akceptuję
                    <a href="/terms" target="_blank">regulamin</a> *</label
                  >
                </div>
        ...
        <div class="col-lg-5 order-1 order-lg-2">
          <div class="peatures_image-wrap section-space--mb_40">
            <div class="image text-center wow move-up">
              <img
                class="img-fluid"
                src="../../assets/img/forms/contact-form-image-01.png"
                alt="contact thumb"
              />
            </div>
          </div>
  ...
  methods: {
    async handleSubmit() {
      ...
      if (password !== confirm_password) {
        password_error.textContent = textData.register.samePassword;
        return false;
      } else {
        if (this.$refs.form.checkValidity() && this.acceptTerms) {
          ...
          try {
            ...
            if (response.status === 201) {
              ...
              password_error.textContent = textData.register.success;
              this.acceptTerms = false;
            }
          } catch (error) {
            console.error(error);
            password_error.textContent = textData.register.tryAgain;
          }
        }
      }
      return true;
