<template>
  <swiper
    ...
    class="mySwiper"
  >
    <swiper-slide v-for="(item, i) in cards" :key="i">
      <div
        class="h-[200px] bg-gradient-to-r relative rounded-md z-[1] p-4 text-white"
        :class="item.bg"
      >
        ...
        <div class="text-xs text-opacity-75 mb-[2px]">Card balance</div>
