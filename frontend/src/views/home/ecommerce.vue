      ...
      return {
        ...
        chartOptions: {
          ...
          legend: {
            ...
            labels: {
              colors: this.$themeSettingsStore.isDark ? "#CBD5E1" : "#475569",
            },
            itemMargin: {
              horizontal: 18,
              vertical: 0,
          ...
          title: {
            ...
            offsetX: this.$themeSettingsStore.direction ? "0%" : 0,
            offsetY: 13,
            floating: false,
            style: {
              fontSize: "20px",
              fontWeight: "500",
              fontFamily: "Inter",
              color: this.$themeSettingsStore.isDark ? "#fff" : "#0f172a",
            },
          },
          dataLabels: {
            enabled: false,
          ...
          yaxis: {
            opposite: this.$themeSettingsStore.direction ? true : false,
            labels: {
              style: {
                colors: this.$themeSettingsStore.isDark ? "#CBD5E1" : "#475569",
                fontFamily: "Inter",
          ...
          grid: {
            show: true,
            borderColor: this.$themeSettingsStore.isDark
              ? "#334155"
              : "#E2E8F0",
            strokeDashArray: 10,
            position: "back",
